<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/profile-cover.svg?v=4" />
  <img src="./assets/profile-cover-light.svg?v=4" alt="Jeong Hwan Ju — Post-training Research Engineer" width="100%" />
</picture>
